...
/*   Updated: 2023/03/10 14:29:24 by acouture         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_textures_player(t_data *data)
{
	...
	data->textures.player_front[3] = mlx_load_png("./png/front/front1.png");
	...
	data->textures.player_back[3] = mlx_load_png("./png/back/back.png");
	...
	data->textures.player_left[3] = mlx_load_png("./png/left/left.png");
	...
	data->textures.player_right[3] = mlx_load_png("./png/right/right.png");
}

// void	load_textures_enemy(t_data *data)
// {
// 	data->textures.enemy_front[0] = mlx_load_png("./png/front/front1.png");
// 	data->textures.enemy_front[1] = mlx_load_png("./png/front/front2.png");
// 	data->textures.enemy_front[2] = mlx_load_png("./png/front/front3.png");
// 	data->textures.enemy_back[0] = mlx_load_png("./png/back/back.png");
// 	data->textures.enemy_back[1] = mlx_load_png("./png/back/back1.png");
// 	data->textures.enemy_back[2] = mlx_load_png("./png/back/back2.png");
// 	data->textures.enemy_left[0] = mlx_load_png("./png/left/left.png");
// 	data->textures.enemy_left[1] = mlx_load_png("./png/left/left1.png");
// 	data->textures.enemy_left[2] = mlx_load_png("./png/left/left2.png");
// 	data->textures.enemy_right[0] = mlx_load_png("./png/right/right.png");
// 	data->textures.enemy_right[1] = mlx_load_png("./png/right/right1.png");
// 	data->textures.enemy_right[2] = mlx_load_png("./png/right/right2.png");
// }